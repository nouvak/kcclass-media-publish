...
class PicassawebService:
    ...
    def __init__(self, username, password):
        self.slideshare_service = gdata.photos.service.PhotosService()
        # Turn on HTTPS/SSL access.
        # Note: SSL is not available at this time for uploads.
        self.slideshare_service.ssl = False
        #self.slideshare_service.developer_key = 'AI39si6-qCVmA8KI53Eg3NF5VjnsvKYzsmzD4njj0VFnQDWgh-Iv0X3h_ABBCAwMWDe_G3VzEHGcTrd6eAy9QBPKBb3CDDDXJw'
        #self.slideshare_service.client_id = 'kcclass-media-publish'
        self.slideshare_service.source = 'kcclass-media-publish'
        # authenticate the user.
        self.slideshare_service.email = username
        self.slideshare_service.password = password
        self.slideshare_service.ProgrammaticLogin()
    ...
    def publish(self, filepath, pub_metadata):
        ...
        # publish image.
        albums = self.slideshare_service.GetUserFeed()
        ...
        image_id = self.slideshare_service.InsertPhotoSimple(album_url, pub_metadata.title, 
...
#            is_private = None
    ...
    def unpublish(self, image_id):
        ...
        self.slideshare_service.Delete(image_id)
