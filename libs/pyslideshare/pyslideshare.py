...
make_slideshow_private, generate_secret_url, allow_embeds, share_with_contacts
    ...
    def delete_slideshow(self, username=None, password=None, slideshow_id=None):
        """
        ...
        if not slideshow_id:
            print >> sys.stderr, 'slideshow_id is needed for this call.'
            sys.exit(1)
        return self.make_call('delete_slideshow', username=username, 
                              password=password, slideshow_id=slideshow_id)
